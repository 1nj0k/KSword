...
\path{docs/next/arxiv/build-validation.json} records that review, and every
other check, against the exact build it names, and says which checks were not
performed --- so the claim here and the record there cannot drift apart. This
preprint has not been peer reviewed or submitted to arXiv as part of its
preparation, and it does not
