...
We separate three evidence scopes. The \emph{current Pro cohort} uses the
implementation subsequently committed as \code{bd703d84}, the version~3 lease,
and the driver hash beginning \code{3b44132f}. The \emph{historical 4-by-2 cohort}
...
trust certification. No driver was rebuilt for preparation of this manuscript.
