...
\path{admission-probe.json} holds the coarse-source attempts and
\path{published.json} the both-rules comparison, each with the driver and
controller hashes, the live EPT12 pointer, the raw JSON of every attempt and its
removal, and a status snapshot.
