...
| Manuscript and artifact | Version-consistent claims, reproducible analysis, anonymized submission copy | Submission Markdown and claim boundaries updated; final anonymous evidence reruns all analyses and checks identity redaction, manifests and ZIP integrity. Full anonymous buildable source artifact and full manuscript remain separate work |
