...
时间(UTC): 2026-09-12T18:21:48.2607594Z → 2026-09-12T18:27:16.4485996Z
...
| status | OK |  |
| prepare | OK |  |
| prune:before-driver-load-0912-1406 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:self-test | OK |  |
| alive:self-test | OK | 虚拟机仍然响应，且没有重启过 |
| self-test | OK |  |
| prune:before-self-test-0912-141911 | OK | 自动修剪旧检查点以回收磁盘 |
| checkpoint:soak | OK |  |
...
原始 JSON: `acceptance-autotest-20260912-142148.json`
